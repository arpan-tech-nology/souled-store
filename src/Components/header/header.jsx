        ...
        <div className=" flex justify-between w-[96%] ">
            ...
            <div className=" nav-item flex w-[82%] justify-between ">
                <ul className="flex items-center text-[20px] font-bold justify-between w-[100%] ">
                    <li className="item relative">MEN</li>
                    <li>WOMEN</li>
                    <li>SNEAKERS</li>
                </ul>
            </div>
            ...
            <div className="search-container  flex w-[32%]  items-center justify-between ">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 -960 960 960" width="28px" fill="#000000"><path d="M234-276q51-39 114-61.5T480-360q69 0 132 22.5T726-276q35-41 54.5-93T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 59 19.5 111t54.5 93Zm146.5-204.5Q340-521 340-580t40.5-99.5Q421-720 480-720t99.5 40.5Q620-639 620-580t-40.5 99.5Q539-440 480-440t-99.5-40.5ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm100-95.5q47-15.5 86-44.5-39-29-86-44.5T480-280q-53 0-100 15.5T294-220q39 29 86 44.5T480-160q53 0 100-15.5ZM523-537q17-17 17-43t-17-43q-17-17-43-17t-43 17q-17 17-17 43t17 43q17 17 43 17t43-17Zm-43-43Zm0 360Z"/></svg>
                {/* <img data-v-0a2dc9ea src="https://prod-img.thesouledstore.com/static/mship-profile.svg?w=30&dpr=2" alt="wishlist" width="25" height="25" class="gm-added gm-loaded gm-observing gm-observing-cb"></img> */}
                ...
                {/* <img data-v-0a2dc9ea src="https://prod-img.thesouledstore.com/static/mship-wishlist.svg?w=30&dpr=2" alt="wishlist" width="23" height="23" class="gm-added gm-loaded gm-observing gm-observing-cb"></img> */}
                ...
                {/* <img data-v-0a2dc9ea src="https://prod-img.thesouledstore.com/static/shopping-cart.svg?w=30&dpr=2" alt="Cart" width="25" height="25" class="headercart gm-added gm-loaded gm-observing gm-observing-cb"></img> */}
            </div>
            </div>
            ...
            <div className="header-category-section w-full  justify-center hidden " >
                <ul className=" nav-menu flex w-full items-center justify-between text-[18px] pt-3 pb-3 ">
                    <li className="flex justify-center item w-[25%] border-[#d3d4d8]  border-r-[1px] relative font-bold">MEN</li>
                    <li className="flex justify-center border-[#d3d4d8]  border-r-[1px] w-[25%]">WOMEN</li>
                    <li className="flex justify-center w-[25%]">SNEAKERS</li>
                </ul>
            </div>
