...
import { openSidebar ,openCart } from "../../Redux/CartSlice/cartSlice";
...
export default function Header() {
    ...
    const WishlistIcon = () => (
        <Link to="/wishlist">
            <div className="relative flex items-center icon">
        ...
        <>
            <div className="header flex-col">
                ...
                <div className="header-height w-full flex justify-center shadow-[0_0px_5px_rgba(0,0,0,0.25)] z-10 relative h-[70px]">
                    <div className=" flex justify-between w-[96%] ">
                        ...
                        <div className=" nav-item-container flex w-[23%]  justify-between ">
                            <div className="flex w-[50px]  items-center cursor-pointer " onClick={handleSidebarOpen}>
                            ...
                            <div className=" nav-item flex w-[82%] justify-between ">
                                <ul className="flex items-center text-[20px] font-bold justify-between w-[100%] ">
                                    <Link to="/">
                                        ...
                                        <li className={`nav-item  relative ${location.pathname === "/" || location.pathname.includes("/men")? "item" : ""}`}  >MEN</li>
                                    </Link>
                                    {/* <li><a >WOMEN</a></li> */}
                                    <Link to="/womenPage"><li className={`nav-item relative ${ location.pathname.includes("/women") ? "item" : ""}`}>WOMEN</li></Link>
                                    <Link to="/sneakerPage">

                                        <li className={`nav-item relative ${ location.pathname.includes("/sneaker") ? "item" : ""}`}>SNEAKERS</li>
                                    </Link>
                                </ul>
                            </div>
                        </div>
                        <div className="logo-img w-[95px] flex items-center cursor-pointer">
                           <Link to="/">
                        ...
                        <div className="search-container  flex w-[32%]  items-center justify-between ">
                            <div className=" relative flex justify-between rounded-full border w-[67%] border-black  h-[45px] p-4 items-center">
                                    ...
                                    filteredProducts.slice(0, 5).map(product => (
                                        <Link key={product.product_id} to={`/product/${product.product_id}`} onClick={() => setSearchTerm("")}>
                                            <div className="flex items-center gap-3 p-3 hover:bg-gray-100 cursor-pointer">
                                                <img src={`../images/${product.image_url}`} alt={product.title} className="w-10 h-10 object-cover rounded" />
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 -960 960 960" width="28px" fill="#000000"><path d="m480-120-58-52q-101-91-167-157T150-447.5Q111-500 95.5-544T80-634q0-94 63-157t157-63q52 0 99 22t81 62q34-40 81-62t99-22q94 0 157 63t63 157q0 46-15.5 90T810-447.5Q771-395 705-329T538-172l-58 52Zm0-108q96-86 158-147.5t98-107q36-45.5 50-81t14-70.5q0-60-40-100t-100-40q-47 0-87 26.5T518-680h-76q-15-41-55-67.5T300-774q-60 0-100 40t-40 100q0 35 14 70.5t50 81q36 45.5 98 107T480-228Zm0-273Z"/></svg>
                                ...
                                {/* <Link to="/wishlist">
                        <div className="relative nav-icon flex items-center"><svg xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 -960 960 960" width="28px" fill="#4b5563"><path d="m480-120-58-52q-101-91-167-157T150-447.5Q111-500 95.5-544T80-634q0-94 63-157t157-63q52 0 99 22t81 62q34-40 81-62t99-22q94 0 157 63t63 157q0 46-15.5 90T810-447.5Q771-395 705-329T538-172l-58 52Zm0-108q96-86 158-147.5t98-107q36-45.5 50-81t14-70.5q0-60-40-100t-100-40q-47 0-87 26.5T518-680h-76q-15-41-55-67.5T300-774q-60 0-100 40t-40 100q0 35 14 70.5t50 81q36 45.5 98 107T480-228Zm0-273Z" /></svg>
                                ...
                                <div className="flex w-[28%] justify-between ">
                                    <WishlistIcon />
                                    <div className="icon relative" onClick={()=>dispatch(openCart())}>
                        ...
                        <div className="header-icons items-center justify-end gap-3 w-[40%] hidden pt-2">
                            <svg xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 -960 960 960" width="28px" fill="#000000" className="cursor-pointer"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z" /></svg>

                            <div className="header-icons flex items-center gap-3 md:hidden">
                                <WishlistIcon />
                                <div className="icon" onClick={()=>dispatch(openCart())}>
                            ...
                            {/* <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M240-80q-33 0-56.5-23.5T160-160v-480q0-33 23.5-56.5T240-720h80q0-66 47-113t113-47q66 0 113 47t47 113h80q33 0 56.5 23.5T800-640v480q0 33-23.5 56.5T720-80H240Zm0-80h480v-480h-80v80q0 17-11.5 28.5T600-520q-17 0-28.5-11.5T560-560v-80H400v80q0 17-11.5 28.5T360-520q-17 0-28.5-11.5T320-560v-80h-80v480Zm160-560h160q0-33-23.5-56.5T480-800q-33 0-56.5 23.5T400-720ZM240-160v-480 480Z" /></svg> */}
                                     <div className=" cursor-pointer relative" onClick={()=>dispatch(openCart())}>
